...
import { LiveWaveform } from "@/sjsu/components/ui/live-waveform";
  ...
  (
    ...
    return (
      ...
      >
        ...
        <div
          className={cn(
            "relative box-content flex shrink-0 items-center justify-center overflow-hidden transition-colors duration-150",
            size === "icon"
              ? "absolute inset-0 rounded-sm border-0"
              : "h-5 w-24 rounded-sm border",
            isRecording
              ? "bg-card/10 dark:bg-card/5"
              : size === "icon"
